...
5. Em **Authentication → URL Configuration**, permita `https://tuliodubiella-arch.github.io/painel-rotinas-grupo-cavalca/fechamento/` como redirect URL. Configure o GitHub Pages para publicar a branch `main` a partir da raiz.
